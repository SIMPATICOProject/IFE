...
function pageLoaded() {
    ...
    /*** HI IBERIA SESSION-FEEDBACK ***/
    var button_session_feedback = jQuery("#BS607AFICHA");
    ...
    button_session_feedback.click(function() {
        ...
        // Faces
        jQuery('#face-radio-buttons-session-feedback label').click(function() {
            jQuery(this).addClass('selected').siblings().removeClass('selected');
        });

        //var html_modal_session_feedback = "sé Rodríguez vuelve a España para jugar en la Unión Deportiva Las Palmas hasta final de temporada. Después de su fichaje por el PSG a cambio de 25 millones de euros, el canario regresa con la esperanza de repetir en la isla los grandes tantos que marcó en su etapa en el Real Madrid con la continuidad que no tuvo en el Bernabéu.";
        //html_modal_session_feedback = "Text 1";

        //var margin_bottom_sides = 100;
        //var session_feedback_buttons_html = '<div id="buttons_session_feedback"><div class="mais" id="button_cancel_session_feedback" style="position:relative;float:left;margin-left:20px;margin-bottom:20px;"><a id="button_cancel_session_feedback_text" style="border-radius:5px 5px 5px 5px;width:auto;">No quiero</a></div> <div class="mais" id="button_send_session_feedback" style="position:relative;float:right;bottom:5px;"><a id="button_send_session_feedback_text" style="border-radius:5px 5px 5px 5px;width:auto;">Enviar</a></div></div>'
        var modal_session_feedback = jQuery("#dialog_modal_session_feedback");
        //modal_session_feedback.children('.mensaje').html(html_modal_session_feedback);
        //modal_session_feedback.append(session_feedback_buttons_html);
        ...
        jQuery(".ui-dialog-overlay").css("opacity", "0.7");
        modal_session_feedback.show();
    });

    // Click function button close
    jQuery("#button_cancel_session_feedback").click(function() {
        jQuery("#dialog_modal_session_feedback").dialog('close');
    });
    // Click function button send
    jQuery("#button_send_session_feedback").click(function() {
        // Get and check data
        ...
        $.post("http://213.98.52.219:4570/simpatico/api/logs/insert" ,JSON.stringify(postData));
    ...
    // Click function button send
    jQuery("#button_cancel_session_feedback_text").click(function() {
        jQuery("#dialog_modal_session_feedback").dialog('close');
        jQuery("#dialog_session_feedback_sended").dialog('close');
    });
