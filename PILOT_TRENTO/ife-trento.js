...
function initFeatures() {
  ...
  function addSimpaticoBar(containerID) {
    var simpaticoCopy = "SIMPATICO helps you with the e-services!";
...
// - containerID: the Id of the element which is going to contain the toolbar 
  ...
  function toggleBottomBar(){
      $("#simp-bottomBar-container-right").toggle('slow', function(){
  ...
  function openGuideDiagram(){
    ...
    if (guideModalContainer == null) {
      ...
      var guideModalHTML='<div class="guide-modal" id="guideModal">'+
        ...
        var idProfile = null; 
        waeUI.getInstance().enable(idProfile);
  ...
  function sendQuestion(){
    console.log("(from ife-trento.js)url::",qaeCORE.getInstance().createQuestionURL);
    console.log("(from ife-trento.js)addQuestionLabel:.addQuestionLabel:",citizenpediaUI.getInstance().addQuestionLabel);
    console.log("(from ife-trento.js)addQuestionLabel:.init.addQuestionLabel:",citizenpediaUI.getInstance().init.addQuestionLabel);
    // window.open(qaeCORE.getInstance().createQuestionURL+"?tags=Infanzia,"+simpaticoEservice,"_blank");
  }
